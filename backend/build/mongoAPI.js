...
exports.saveRequest = exports.getBinRequests = void 0;
...
const getBinRequests = (endpoint) => {
    return models_1.default.find({ endpoint: endpoint }).sort({ createdAt: 'desc' }).exec();
};
exports.getBinRequests = getBinRequests;
const saveRequest = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const result = {
        headers: req.headers,
